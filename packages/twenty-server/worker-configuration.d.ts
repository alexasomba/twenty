/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e733f761e64f0b254418acacd375d09b)
// Runtime types generated with workerd@1.20260103.0 2026-01-01 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		...
		SERVER_URL: "https://api.twenty.com" | "https://staging-api.twenty.com";
		D1_DATABASE_ID: string;
		D1_PREVIEW_DATABASE_ID: string;
		KV_CACHE_NAMESPACE_ID: string;
		KV_CACHE_PREVIEW_ID: string;
		KV_SESSION_NAMESPACE_ID: string;
		KV_SESSION_PREVIEW_ID: string;
		JWT_SECRET: string;
		...
		CODE_INTERPRETER_TYPE: string;
		FRONTEND_URL: string;
		EXCEPTION_HANDLER_DRIVER: string;
		TELEMETRY_ENABLED: string;
		SENTRY_DSN: string;
		MUTATION_MAXIMUM_RECORD_AFFECTED: string;
		IS_MULTIWORKSPACE_ENABLED: string;
		AUTH_GOOGLE_ENABLED: string;
		MESSAGING_PROVIDER_GMAIL_ENABLED: string;
		IS_IMAP_SMTP_CALDAV_ENABLED: string;
		CALENDAR_PROVIDER_GOOGLE_ENABLED: string;
		MESSAGING_PROVIDER_MICROSOFT_ENABLED: string;
		CALENDAR_PROVIDER_MICROSOFT_ENABLED: string;
		...
		IS_WORKSPACE_CREATION_V2_ENABLED: string;
		REALTIME_HUB: DurableObjectNamespace /* WorkspaceRealtimeHub */;
		FILES: R2Bucket;
		DB: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "LOG_LEVEL" | "SERVER_URL" | "D1_DATABASE_ID" | "D1_PREVIEW_DATABASE_ID" | "KV_CACHE_NAMESPACE_ID" | "KV_CACHE_PREVIEW_ID" | "KV_SESSION_NAMESPACE_ID" | "KV_SESSION_PREVIEW_ID" | "JWT_SECRET" | "JWT_REFRESH_SECRET" | "ENCRYPTION_KEY" | "R2_ACCESS_KEY_ID" | "R2_SECRET_ACCESS_KEY" | "NODE_ENV" | "PG_DATABASE_URL" | "REDIS_URL" | "APP_SECRET" | "SIGN_IN_PREFILLED" | "CODE_INTERPRETER_TYPE" | "FRONTEND_URL" | "EXCEPTION_HANDLER_DRIVER" | "TELEMETRY_ENABLED" | "SENTRY_DSN" | "MUTATION_MAXIMUM_RECORD_AFFECTED" | "IS_MULTIWORKSPACE_ENABLED" | "AUTH_GOOGLE_ENABLED" | "MESSAGING_PROVIDER_GMAIL_ENABLED" | "IS_IMAP_SMTP_CALDAV_ENABLED" | "CALENDAR_PROVIDER_GOOGLE_ENABLED" | "MESSAGING_PROVIDER_MICROSOFT_ENABLED" | "CALENDAR_PROVIDER_MICROSOFT_ENABLED" | "AUTH_GOOGLE_CALLBACK_URL" | "AUTH_GOOGLE_APIS_CALLBACK_URL" | "MESSAGING_PROVIDER_GMAIL_CALLBACK_URL" | "AUTH_MICROSOFT_CALLBACK_URL" | "AUTH_MICROSOFT_APIS_CALLBACK_URL" | "CLICKHOUSE_URL" | "IS_WORKSPACE_CREATION_V2_ENABLED">> {}
}
